    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(!username.isEmpty() && !password.isEmpty()){
         ...
         //   http1 111
            ...
            if(result.getCode() == 1)
            {
                    listenerManager.registerUserQueueListener(username, this); // this 实现 ChatMessageHandler
            }
//            listenerManager.registerUserQueueListener(username, new ChatMessageHandler() {
//                @Override
//                public void onPrivateMessage(ChatMessage msg) {
//                    chatFrame.appendMessage(msg);
//                }
//                @Override
//                public void onGroupMessage(ChatMessage msg) {
//                    chatFrame.appendMessage(msg);
...
//                @Override
//                public void onUserStatus(ChatMessage msg) {
//                    chatFrame.updateUserStatus(msg);
//                }
//            });
            log.info(result.toString());
        }
