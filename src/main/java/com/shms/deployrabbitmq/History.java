...
import com.shms.deployrabbitmq.ui.HistoryFrame;
...
public class History {
    ...
    public void addMessage(ChatMessage msg, String time){
        ...
        try {
            ...
            Element _sender = doc.createElement("sender"); _sender.setTextContent(msg.getSender());
            Element _content = doc.createElement("content"); _content.setTextContent(msg.getContent());
            Element _recipient = doc.createElement("recipient"); _recipient.setTextContent(msg.getReceiver());
